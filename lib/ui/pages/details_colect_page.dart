...
class DetailsColectPage extends StatelessWidget {
  Collect collect;
      ...
      builder: (context, model, child) => Scaffold(
        body: Column(
          children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 10),
                          Text(
                            'Verifique as informações da coleta e clique no botão "aceitar coleta" para aceitar e realizar a coleta dos materias informados',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 13,
            ...
            DefaultButton(
                texto: 'Aceitar Coleta',
                onPressed: () {
                  model.acceptCollect(collect.sId, '2').then((responseApi) => {
